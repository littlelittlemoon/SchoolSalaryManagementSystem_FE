    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator=">>">
                ...
                <el-breadcrumb-item><i></i>添加新员工</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="div-block">
            ...
            <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                ...
                <el-form-item label="所属部门" prop="staffDepartment">
                ...
                <el-form-item label="员工职务" prop="staffDuty">
                ...
                <el-form-item label="系统角色" prop="staffRole">
                ...
                <el-form-item label="入职时间" required>
                    <el-col :span="11">
                        <el-form-item prop="entryTime">
                            <el-date-picker format="yyyy-MM-dd" type="date" placeholder="选择入职日期"
        ...
        methods: {
            submitForm(formName) {
                this.$refs[formName].validate((valid) => {
                        if (valid) {
                            axios.post('http://localhost:8080/staffInfo/addStaff', qs.stringify(
                                {
